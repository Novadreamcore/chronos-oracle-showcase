...
The current workbench combines four research surfaces in one application:
...
ThoughtStream recurrence, self-reference, semantic attractors, DreamCore recombination and related phenomena are treated as **research objects**, not conclusions.
...
See [`protocols/`](protocols/) for intentionally limited public examples of the kinds of questions and controls used during development.
